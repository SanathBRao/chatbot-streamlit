...
if st.button("Generate Image"):
    with st.spinner("Generating image..."):
        try:
            # Correct way to generate image using the Google Generative AI API
            ...
            if 'candidates' in response and len(response.candidates) > 0:
                image_part = response.candidates[0].content.parts[1]  # Image data is in the second part
                ...
                st.error("No valid response received for the image generation.")
